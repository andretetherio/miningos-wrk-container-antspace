...
test('alerts - supply_liquid_temp_low validation', (t) => {
  ...
  const originalIsValidSnap = require('@tetherto/miningos-tpl-wrk-container/workers/lib/utils').isValidSnap
  ...
  require('@tetherto/miningos-tpl-wrk-container/workers/lib/utils').isValidSnap = () => true
  ...
  require('@tetherto/miningos-tpl-wrk-container/workers/lib/utils').isValidSnap = () => false
  ...
  require('@tetherto/miningos-tpl-wrk-container/workers/lib/utils').isValidSnap = originalIsValidSnap
